        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <button className="btn-ghost-light inline-flex items-center gap-2">
            ...
            <div className="mt-12 relative max-w-xl">
              <input
                ...
                className="w-full pl-12 pr-32 py-4 bg-white/[0.06] border border-white/15 rounded-2xl text-white placeholder-white/40 backdrop-blur-md focus:ring-2 focus:ring-orange-500/40 focus:border-orange-500/60 focus:bg-white/[0.10] transition-all duration-300 outline-none"
              />
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-white/50" />
              <button className="absolute right-2 top-2 bottom-2 bg-orange-500 hover:bg-orange-600 text-white px-6 rounded-xl font-semibold transition-colors">
                Buscar
              </button>
            </div>
          </motion.div>
          ...
          >
            <div className="glass-dark rounded-3xl p-6 relative overflow-hidden">
              {/* Banner image header inside card */}
                  ...
                  {BANNERS.map((_, i) => (
                    <button
                      ...
                      className={`h-1.5 rounded-full transition-all duration-300 ${
                        currentBanner === i ? 'w-6 bg-orange-500' : 'w-1.5 bg-white/40'
                      }`}
                    />
                  ))}
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-2xl p-4 bg-white/[0.04] border border-white/10">
                  <div className="flex items-center gap-2 text-white/60 text-xs uppercase font-bold tracking-wider mb-2">
                    <Award className="w-3.5 h-3.5 text-orange-500" /> Certificados
                  </div>
                  <div className="text-2xl font-display font-bold text-white">12</div>
                  <div className="text-[11px] text-white/50 mt-1">+3 este mês</div>
                </div>
                <div className="rounded-2xl p-4 bg-white/[0.04] border border-white/10">
                  <div className="flex items-center gap-2 text-white/60 text-xs uppercase font-bold tracking-wider mb-2">
                    <TrendingUp className="w-3.5 h-3.5 text-orange-500" /> Progresso
                  </div>
                  <div className="text-2xl font-display font-bold text-white">68%</div>
                  <div className="w-full bg-white/10 rounded-full h-1.5 mt-2 overflow-hidden">
                    <div className="h-full rounded-full" style={{ width: '68%', background: 'var(--gradient-orange)' }} />
                  </div>
                </div>
              </div>
            </div>
